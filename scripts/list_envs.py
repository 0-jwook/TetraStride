...
All the environments are registered in the `quadrupedal_bot` extension. They start
...
import quadrupedal_bot.tasks  # noqa: F401


def main():
    """Print all environments registered in `quadrupedal_bot` extension."""
